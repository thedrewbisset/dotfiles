...
This file is now **generated automatically** by the discovery step — see
[discovery.md](discovery.md). It is no longer hand-authored. The format below
is what the generated manifest looks like; you shouldn't need to write one by
hand except to manually override discovery for a one-off run.
